...
Get the necessary patches for compiling [here](https://github.com/egc112/OpenWRT-egc-add-on/tree/main/openvpn-scramble/feeds/66), For 24.10, 25.12 and Main builds with Kernel 6.6 or 6.12 and OpenVPN 2.6.X use patches from `feeds/66`.  
For Kernel 6.18 and/or OpenVPN 2.7 use patches from [feeds/618](https://github.com/egc112/OpenWRT-egc-add-on/tree/main/openvpn-scramble/feeds/618)  
