...
readonly PKG_VERSION='1.1.8-r26-egc-boot-delay-1'
...
#	ubus -t 30 wait_for network.interface 2>/dev/null
	pbr_boot_flag=1
	{ is_integer "$procd_boot_delay" && logger "pbr EGC-601 after boot_delay=$procd_boot_delay"; sleep "$procd_boot_delay"; logger "pbr EGC-602 after boot_delay=$procd_boot_delay"; \
