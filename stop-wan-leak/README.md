...
Version: 0.93 5-nov-2025 by egc  
...
Installation:  
Copy script from:  
https://raw.githubusercontent.com/egc112/OpenWRT-egc-add-on/main/stop-wan-leak/09-stop-wan-leak to `/etc/hotplug.d/iface` on your router, either from commandline (SSH):  
```
